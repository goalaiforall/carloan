...
Monto sujeto a impuesto después del trade-in: ${formatCad(results.taxableAmount, locale)}
    ...
    <main id="calculator">
      ...
      <section className="panel breakdown">
        ...
        <div className="breakdownList">
          ...
          <div className="goodRow"><span>{t.taxCredit}</span><strong>- {formatCad(results.tradeInTaxCredit, locale)}</strong></div>
          <div><span>{t.taxable}</span><strong>{formatCad(results.taxableAmount, locale)}</strong></div>
